...
//         style={{
//           backgroundImage:
//             'url("https://t3.ftcdn.net/jpg/02/99/23/72/360_F_299237262_Cj3wYz3HK7Aak1qNW4biP268qL1wphOr.jpg")',
//         }}
//       />
...
function ContactUs() {
  ...
  const handleFormSubmit = (e) => {
    ...
    if (fullName && email && message) {
      ...
      emailjs.send(
        'service_r41wfp8', // Replace with your EmailJS service ID
        'template_eaugpkh', // Replace with your EmailJS template ID
        {
          fullName: fullName,
          email: email,
          message: message,
        },
        'ccECmhhqoae_wCchb' // Replace with your EmailJS user ID
      )
      .then((response) => {
