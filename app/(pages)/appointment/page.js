...
function AppointmentPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
      <h1 className="text-4xl font-semibold mb-6">Book an Appointment</h1>
      <form className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg space-y-4" onSubmit={handleFormSubmit}>
        <div>
